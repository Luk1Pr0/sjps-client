...
export default function KodeksUcznia() {
	return (
		<>
			<Head>
			...
			<main className="main main--kodeks-ucznia">
				...
				<section className="content-wrapper content-wrapper--center text--left">
				...
				<section className="content-wrapper content-wrapper--center text--center">
					...
					<strong>
						...
						<h4>SZKOŁA NIE PONOSI ODPOWIEDZIALNOŚCI ZA PRZEDMIOTY WARTOŚCIOWE, ZGUBIONE, SKRADZIONE LUB ZNISZCZONE, PRZYNOSZONE PRZEZ DZIECI NA ZAJĘCIA.</h4>

						<br />

						<h4>NA TERENIE SZKOŁY OBOWIĄZUJE BEZWZGLĘDNY ZAKAZ PALENIA TYTONIU, SPOŻYWANIA ALKOHOLU I NARKOTYKÓW.</h4>
