...

				{
					!updatesList.length ?
						...
						updatesList.map((update) => (
							<AktualnosciItem key={update._id} updateId={update._id} title={update.title} message={update.message} fileName={update.fileName} fileUrl={update.fileUrl} dateAdded={update.dateAdded} />
						))
